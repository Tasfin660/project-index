	...
	return (
		<section className="container relative mt-16">
			...
			<div
				...
				ref={sliderRef}>
				{status === 'Completed' && (
					<div className="sticky left-0 z-10 flex h-[188px] w-[200px] shrink-0 flex-col items-center justify-center gap-2 rounded-lg bg-clr-green-grad">
						<FaCheck className="box-content rounded-full bg-emerald-200/20 p-2.5 text-lg" />
						<p className="text-xl font-medium">Completed</p>
					</div>
				)}
				{status == 'Ongoing' && (
					<div className="sticky left-0 z-10 flex h-[188px] w-[200px] shrink-0 flex-col items-center justify-center gap-2 rounded-lg bg-clr-yellow-grad">
						<FaRepeat className="box-content rounded-full bg-emerald-200/20 p-2.5 text-lg" />
						<p className="text-xl font-medium">Ongoing</p>
					</div>
				)}
				{status === 'Postponed' && (
					<div className="sticky left-0 z-10 flex h-[188px] w-[200px] shrink-0 flex-col items-center justify-center gap-2 rounded-lg bg-clr-red-grad">
